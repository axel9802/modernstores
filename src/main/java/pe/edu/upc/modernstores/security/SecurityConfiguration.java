...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
				...
				.antMatchers("/modernstores/comerciantes").hasAnyRole("COMERCIANTE","ADMINISTRADOR", "CLIENTE")
				...
				.antMatchers("/modernstores/comerciantes/edit/**").hasAuthority("ACCESS_EDITMERCHANT")
				.antMatchers("/modernstores/comerciantes/new/**").hasAuthority("ACCESS_ADDMERCHANT")
